...
const count = (target, input) => {
  // Solution code here...
  let countArr = input.reduce(function (accumulatorArr, valueArr) {
    let countEl = valueArr.reduce(function (accumulatorEl, valueEl) {
      if (valueEl === target) {
        accumulatorEl += 1;
...
const totalSum = (input) => {
  // Solution code here...
  let sumArr = input.reduce(function (accumulatorArr, valueArr) {
    let sumEl = valueArr.reduce(function (accumulatorEl, valueEl) {
